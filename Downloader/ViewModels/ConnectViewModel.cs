			...
			return new ApplicationResponse()
			{
				...
				ApplicationBranches = new ApplicationBranchResponse[]
				{
					new ApplicationBranchResponse()
					{
						...
						Ref = "master",
						RepoTree = "master",
						BuildDownload = "http://xboxchaos.com/assembly/updatetest/130645409883842251.zip",
						UpdaterDownload = "http://xboxchaos.com/assembly/updatetest/130645420142799639.zip",
